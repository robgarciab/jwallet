...
angular.module('jwalletApp').controller('BankAccountDialogController',
    ['$scope', '$uibModalInstance', 'entity', 'BankAccount',
        function($scope, $uibModalInstance, entity, BankAccount) {
